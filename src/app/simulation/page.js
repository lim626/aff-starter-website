...
const calcTotalDepositPerPlayer = (avgFirstMonthDeposit, depositDistribution) => {
    return avgFirstMonthDeposit * depositDistribution.reduce((sum, dist) => sum + dist, 0);
};
                                                ...
                                                <div className="flex items-center space-x-4 px-6 py-4 rounded-[20px]">
                                                    <input
                                                        ...
                                                        onChange={(e) => {
                                                            ...
                                                            const newDistribution = [...params.depositDistribution];
                                                            newDistribution[i] = newValue / 100;
                                                            handleInputChange('depositDistribution', newDistribution);
                                                        }}
                                                        className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer 
                                 [&::-webkit-slider-thumb]:appearance-none
                                 [&::-webkit-slider-thumb]:w-6
                ...
                {results && (
                    <div className="mt-20">
                        ...
                        <div className='flex justify-center relative transition-transform duration-300 transform hover:animate-scale'>
                            <img src="./img/simulation1.png" className='w-[60%] translate-y-[-60px] md:translate-y-[-160px] z-[-2] '></img>
                        </div>
                    </div>
                )}
            </div>
